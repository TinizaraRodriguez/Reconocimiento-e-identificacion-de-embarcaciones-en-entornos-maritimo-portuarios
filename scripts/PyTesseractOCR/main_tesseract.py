...
def buildingArguments():
    ...
    #parser.add_argument('configRecModel', help='Config file for recognition tesseract model')
    #parser.add_argument('configDetModel', help='Config file for detection tesseract model')
...
def main():
    ...
    tesseract(args, start_time)

    print("Finalizada la ejecucion de tesseract")
